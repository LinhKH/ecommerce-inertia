            ...
            <div class="card-body login-card-body">
                <form id="adminLogin" method="POST">
                    ...
                    <div class="form-group mb-3">
                        <input type="text" class="form-control username" name="username" value="admin" placeholder="Username"
                            required>
                    </div>
                    <div class="form-group mb-3">
                        <input type="password" class="form-control password" value="123456" name="password" placeholder="Password"
                            required>
                    </div>
                    <div class="row">
