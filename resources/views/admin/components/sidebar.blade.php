<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="javascript:void(0)" class="brand-link">
        @if (site_settings()->site_logo != '')
            <img src="{{ asset('site/' . site_settings()->site_logo) }}" class="bg-white p-2" width="100%"
            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{ url('admin/category') }}"
                                class="nav-link {{ Request::path() == 'admin/category' ? 'active bg-primary' : '' }}">
                                <i class="nav-icon far fa-circle"></i>
                                <p>Category</p>
                            </a>
                        </li>
                ...
                <li class="nav-item">
                    <a href="{{ url('admin/reviews') }}"
                        class="nav-link {{ Request::path() == 'admin/reviews' ? 'active' : '' }}">
                ...
                <li class="nav-item">
                    <a href="{{ url('admin/payment-method') }}"
                        class="nav-link {{ Request::path() == 'admin/payment-method' ? 'active' : '' }}">
                ...
                <li
                    class="nav-item has-treeview {{ Request::path() == 'admin/product-sale' || Request::path() == 'admin/product-stock' ? 'menu-open' : '' }}">
                    <a href="javascript:void(0)" class="nav-link">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ url('admin/product-sale') }}"
                                class="nav-link {{ Request::path() == 'admin/product-sale' ? 'active bg-primary' : '' }}">
                                <i class="nav-icon far fa-circle"></i>
                                <p>Products Sale</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ url('admin/product-stock') }}"
                                class="nav-link {{ Request::path() == 'admin/product-stock' ? 'active bg-primary' : '' }}">
                                <i class="nav-icon far fa-circle"></i>
                                <p>Products Stock</p>
                            </a>
                        </li>
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ url('admin/banner') }}"
                                class="nav-link {{ Request::path() == 'admin/banner' ? 'active' : '' }}">
                        ...
                        <li class="nav-item">
                            <a href="{{ url('admin/general-settings') }}"
                                class="nav-link {{ Request::path() == 'admin/general-settings' ? 'active bg-primary' : '' }}">
                                <i class="nav-icon far fa-circle"></i>
                        ...
                        <li class="nav-item">
                            <a href="{{ url('admin/profile-settings') }}"
                                class="nav-link {{ Request::path() == 'admin/profile-settings' ? 'active bg-primary' : '' }}">
                                <i class="nav-icon far fa-circle"></i>
                                <p>Profile Settings</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ url('admin/social-settings') }}"
                                class="nav-link {{ Request::path() == 'admin/social-settings' ? 'active bg-primary' : '' }}">
                                <i class="nav-icon far fa-circle"></i>
